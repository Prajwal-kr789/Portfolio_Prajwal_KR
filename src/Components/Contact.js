...
const Contact = () =>{
    ...
    return(
        <div className='h-screen mt-44 space-y-12 '>        
            <h2 className='text-white sm:text-3xl md:text-3xl lg:text-4xl font-bold text-center ' data-aos="fade-in" data-aos-delay="600">Contact me</h2>

            <div className='flex flex-row justify-around items-center ml-36'>

                <div className='w-5/12 space-y-12 ' data-aos="fade-right">
                    <h2 className='text-white sm:text-3xl md:text-3xl lg:text-4xl font-bold '>Contact Info</h2>
                    ...
                    <a href='tel:7899274216' className='text-white'>+91-7899274216</a>
                    </div>
                </div>
            ...
            <form class="max-w-sm mx-auto " data-aos="fade-left"> 
                ...
                <div class="mb-5 mt-5">
                    ...
                    <input type="email" id="email" class="shadow-sm  border outline-none border-gray-300 text-white text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500 dark:shadow-sm-light" placeholder="Enter your name..." required/>
                </div>
                <div class="mb-5">
                    <label for="password" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Your Email : </label>
                    <input type="text" id="password" class="shadow-sm  border outline-none border-gray-300 text-white text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500 dark:shadow-sm-light" placeholder="Enter your Email..." required/>
                </div>
                <div class="mb-5">
                    <label for="repeat-password" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Your message : </label>
                    <input type="text" id="repeat-password" class="shadow-sm  border h-20 outline-none border-gray-300 text-white text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500 dark:shadow-sm-light" placeholder="Enter your Message..." required/>
                </div>
